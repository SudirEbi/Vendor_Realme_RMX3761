...
# Vendor Boot Image
#TARGET_PREBUILT_VENDOR_BOOT := $(DEVICE_PATH)/prebuilt/vendor-boot.img
#BOARD_VENDOR_BOOT_IMAGE_NAME := vendor-boot.img
#BOARD_MKBOOTIMG_ARGS += --vendor_boot $(TARGET_PREBUILT_VENDOR_BOOT)

# DTB and DTBO
BOARD_KERNEL_SEPARATED_DTBO := true
TARGET_PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/vendor-boot.img
